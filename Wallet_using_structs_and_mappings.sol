...
contract MappingsStructExample {
    ...
    function check_deposit(address _from, uint serial) public view returns (Transaction memory) {
        return balanceReceived[_from].deposits[serial];
    }
     function check_withdrawals(address _from, uint serial) public view returns (Transaction memory) {
        return balanceReceived[_from].withdrawals[serial];
    }
}
